...
function parseAssociationDetail(id, html) {
  ...
  const province = provinceHeading.replace(/\s*一の宮\s*$/u, "").trim().replace("大隈国", "大隅国");
  const nameReading = [...html.matchAll(/<p2[^>]*>([\s\S]*?)<br\s*\/?\s*>/gi)]
    .map((match) => text(match[1]))
    .find((value) => /^[ぁ-ゖー・･\s]+$/u.test(value) && value.length > 2)
    ?.replace(/\s+/g, "") || "";
...
const provinceReadings = {
  "山城国": "やましろのくに", "大和国": "やまとのくに", "河内国": "かわちのくに",
  "和泉国": "いずみのくに", "摂津国": "せっつのくに", "伊賀国": "いがのくに",
  "伊勢国": "いせのくに", "志摩国": "しまのくに", "尾張国": "おわりのくに",
  "三河国": "みかわのくに", "遠江国": "とおとうみのくに", "駿河国": "するがのくに",
  "伊豆国": "いずのくに", "甲斐国": "かいのくに", "相模国": "さがみのくに",
  "武蔵国": "むさしのくに", "安房国": "あわのくに", "上総国": "かずさのくに",
  "下総国": "しもうさのくに", "常陸国": "ひたちのくに", "近江国": "おうみのくに",
  "美濃国": "みののくに", "飛騨国": "ひだのくに", "信濃国": "しなののくに",
  "上野国": "こうずけのくに", "下野国": "しもつけのくに", "陸奥国": "むつのくに",
  "出羽国": "でわのくに", "若狭国": "わかさのくに", "越前国": "えちぜんのくに",
  "加賀国": "かがのくに", "能登国": "のとのくに", "越中国": "えっちゅうのくに",
  "越後国": "えちごのくに", "佐渡国": "さどのくに", "丹波国": "たんばのくに",
  "丹後国": "たんごのくに", "但馬国": "たじまのくに", "因幡国": "いなばのくに",
  "伯耆国": "ほうきのくに", "出雲国": "いずものくに", "石見国": "いわみのくに",
  "隠岐国一の宮（島後）": "おきのくにいちのみや（どうご）",
  "隠岐国一の宮（島前）": "おきのくにいちのみや（どうぜん）",
  "播磨国": "はりまのくに", "美作国": "みまさかのくに", "備前国": "びぜんのくに",
  "備中国": "びっちゅうのくに", "備後国": "びんごのくに", "安芸国": "あきのくに",
  "周防国": "すおうのくに", "長門国": "ながとのくに", "紀伊国": "きいのくに",
  "淡路国": "あわじのくに", "阿波国": "あわのくに", "讃岐国": "さぬきのくに",
  "伊予国": "いよのくに", "土佐国": "とさのくに", "筑前国": "ちくぜんのくに",
  "筑後国": "ちくごのくに", "豊前国": "ぶぜんのくに", "豊後国": "ぶんごのくに",
  "肥前国": "ひぜんのくに", "肥後国": "ひごのくに", "日向国": "ひゅうがのくに",
  "大隅国": "おおすみのくに", "薩摩国": "さつまのくに", "壱岐国": "いきのくに",
  "対馬国": "つしまのくに", "北海道": "ほっかいどう", "津軽国": "つがるのくに",
  "陸中国": "りくちゅうのくに", "岩代国": "いわしろのくに", "知知夫国": "ちちぶのくに",
  "琉球国": "りゅうきゅうのくに"
};
const deityReadings = {
  "001": "かもわけいかづちのおおかみ",
  "002": "たまよりひめのみこと・かもたけつぬみのみこと",
  "003": "おおものぬしのおおかみ・すくなひこなのかみ",
  "004": "あめのこやねのみこと・ひめみかみ・ふつぬしのおおかみ・たけみかづちのおおかみ",
  "005": "やまとたけるのみこと・おおとりのむらじのおやがみ",
  "006": "そこつつのおのみこと・なかつつのおのみこと・うわつつのおのみこと・じんぐうこうごう",
  "007": "いくいのかみ・さくいのかみ・つながいのかみ・はひきのかみ・あすはのかみ",
  "008": "おおひこのみこと・すくなひこなのみこと・かなやまひめのみこと",
  "009": "さるたひこのおおかみ",
  "010": "さるたひこのおおかみ・なかつつのおのみこと・あめのくぬのみこと",
  "011": "あまてらしますすめおおみかみのみたま",
  "012": "わかひるめのみこと・いざわとみのみこと・たまはしらやひめのみこと",
  "013": "あめのほあかりのみこと",
  "014": "おおものぬしのおおかみ・すくなひこなのかみ",
  "015": "おおなむちのみこと", "016": "おおなむちのみこと",
  "017": "ことのまちひめのみこと・ほかさんばしら",
  "018": "このはなのさくやびめのみこと",
  "019": "おおやまつみのみこと・つみはやえことしろぬしのかみ",
  "020": "このはなさくやひめのみこと",
  "021": "さむかわひこのみこと・さむかわひめのみこと",
  "022": "おうじんてんのう・ひめがみ・じんぐうこうごう",
  "023": "すさのおのみこと・いなだひめのみこと・おおなむちのみこと",
  "024": "くしいなだひめのみこと・おおなむちのみこと・みほつひめのみこと",
  "025": "あめのふとだまのみこと・あめのとみのみこと",
  "026": "あめのひりのめのみこと", "027": "たまよりひめのみこと",
  "028": "ふつぬしのおおかみ・たけみかづちのおおかみ", "029": "たけみかづちのおおかみ",
  "030": "やまとたけるのみこと",
  "031": "かなやまひこのみこと（みぬのみこと・ひこほほでみのみこと）",
  "032": "みなしのおおかみ（みとしのかみ）", "033": "やさかとめのかみ",
  "034": "たけみなかたのかみ・やさかとめのかみ・やえことしろぬしのかみ",
  "035": "ふつぬしのかみ・ひめのおおかみ", "036": "とよきいりひこのみこと",
  "037": "おおなむちのみこと・たごりひめのみこと・あじすきたかひこねのみこと",
  "038": "あじすきたかひこねのみこと・やまとたけるのみこと",
  "039": "あじすきたかひこねのみこと・やまとたけるのみこと",
  "040": "あじすきたかひこねのみこと・おおくにぬしのみこと",
  "041": "しおつちおじのかみ・たけみかづちのかみ・ふつぬしのかみ・しわひこのかみ",
  "042": "おおものいみのかみ",
  "043": "ひこほほでみのみこと・とよたまひめのみこと",
  "044": "いざさわけのみこと（しゅさいじん）・ちゅうあいてんのう（たらしなかつひこのみこと）・じんぐうこうごう（おきながたらしひめのみこと）・やまとたけるのみこと・おうじんてんのう（ほんだわけのみこと）・たまひめのみこと・たけのうちのすくねのみこと",
  "045": "くくりひめのかみ・いざなぎのみこと・いざなみのみこと",
  "046": "おおなむちのみこと",
  "047": "おおなむちのみこと（あめのいくたまのみこと・いたけるのみこと）",
  "048": "おおなむちのみこと・ぬなかわひめのみこと",
  "049": "いざなぎのかみ・あめのたぢからおのかみ",
  "050": "ふたがみのかみ（ににぎのみこと）", "051": "あめのかごやまのみこと",
  "052": "おおくにぬしのかみ（ぬなかわひめのみこと・たけみなかたのみこと）",
  "053": "いたけるのみこと", "054": "おおくにぬしのみこと・みほつひめのみこと",
  "055": "ひこほあかりのみこと（とようけのおおかみ・あまてらすおおかみ・わたつみのかみ・あめのみくまりのかみ）",
  "056": "あめのひぼこのみこと・いずしやまえのおおかみ",
  "057": "ひこいますのみこのみこと・あめのみさりのみこと・ひこほほでみのみこと・とよたまのみこと",
  "058": "たけのうちのすくねのみこと", "059": "たけはづちのみこと・したてるひめのみこと",
  "060": "おおくにぬしのおおかみ", "061": "くまののおおかみ・くしみけぬのみこと",
  "062": "うましまぢのみこと", "063": "みずわかすのみこと", "064": "ゆらひめのみこと",
  "065": "おおなむちのかみ", "066": "かがみつくりのかみ", "067": "おおきびつひこのみこと",
  "068": "すさのおのみこと", "069": "おおきびつひこのおおかみ", "070": "おおきびつひこのおおかみ",
  "071": "すさのおのみこと",
  "072": "いちきしまひめのみこと・たごりひめのみこと・たぎつひめのみこと",
  "073": "たまのおやのみこと",
  "074": "うわつつのおのみこと・なかつつのおのみこと・そこつつのおのみこと・おうじんてんのう・たけのうちのすくねのみこと・じんぐうこうごう・たけみなかたのみこと",
  "075": "ひのくまのおおかみ・くにかかすのおおかみ",
  "076": "いたけるのみこと（おおやつひめのみこと・つまつひめのみこと）",
  "077": "にうつひめのおおかみ（わかひるめのかみ）ほかさんばしら",
  "078": "いざなぎのおおかみ・いざなみのおおかみ",
  "079": "おおあさひこのおおかみ・さるたひこのおおかみ",
  "080": "やまとととひももそひめのみこと", "081": "おおやまづみのかみ",
  "082": "あじすきたかひこねのかみ・ひとことぬしのかみ",
  "083": "おうじんてんのう・じんぐうこうごう・たまよりひめのみこと",
  "084": "すみよしさんじん・あまてらすすめおおかみ・じんぐうこうごう",
  "085": "こうらたまたれのみこと・はちまんのおおかみ・すみよしのおおかみ",
  "086": "はちまんのおおかみ・ひめのおおかみ・じんぐうこうごう",
  "087": "ささむたのおおかみ", "088": "おうじんてんのう・ちゅうあいてんのう・じんぐうこうごう",
  "089": "よどひめのみこと", "090": "おうじんてんのう・ちゅうあいてんのう・じんぐうこうごう",
  "091": "たけいわたつのみこと・あそつひめのみこと", "092": "おおなむちのみこと",
  "093": "あまつひだかひこほほでみのみこと・とよたまひめのみこと",
  "094": "あまつひだかひこほのににぎのみこと", "095": "おおひるめのむちのみこと",
  "096": "あめのおしほみみのみこと・あめのたぢからおのみこと",
  "097": "とよたまひめのみこと・うがやふきあえずのみこと",
  "098": "おおくにたまのかみ・おおなむちのかみ",
  "099": "うつしくにたまのかみ・たつひひめのかみ", "100": "こまがたのおおかみ",
  "101": "いざなぎのみこと・いざなみのみこと・おおびこのみこと・たけぬなかわわけのみこと",
  "102": "やごころおもいかねのみこと・ちちぶひこのみこと・あめのみなかぬしのかみ",
  "103": "いざなみのみこと・はやたまおのみこと・ことさかおのみこと"
};
const shrineReadingOverrides = {
  "005": "おおとりたいしゃ",
  "016": "おくにじんじゃ",
  "020": "あさまじんじゃ",
  "023": "ひかわじんじゃ",
...
const shrines = baseShrines.map((shrine) => {
  const completed = { ...shrine, ...(manualDetails[shrine.id] || {}) };
  return {
    ...completed,
    nameReading: shrineReadingOverrides[completed.id] || completed.nameReading,
    provinceReading: provinceReadings[completed.province] || "",
    deityReading: deityReadings[completed.id] || ""
  };
});
